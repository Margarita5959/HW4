...
public class ComplexSearchTests {
    ...
    static void beforeAll() throws IOException {
        ...
        properties.load(new FileInputStream("src/test/java/resources/GET/application.properties"));
    ...
    JsonPath expectedJSON = new JsonPath(FileUtils.readFileToString(
            new File("src/test/java/resources/GET/ComplexSearchExpected.json"), StandardCharsets.UTF_8));
    @Test
